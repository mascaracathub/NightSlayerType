...
local T1UIColor = {
	["Border Color"] = Color3.fromRGB(102, 103, 171), -- Diubah ke Very Peri
	["Click Effect Color"] = Color3.fromRGB(230, 230, 230),
	["Setting Icon Color"] = Color3.fromRGB(230, 230, 230),
	["Logo Image"] = "rbxassetid://137672958847663",
	["Search Icon Color"] = Color3.fromRGB(240, 240, 230),
	["Search Icon Highlight Color"] = Color3.fromRGB(102, 103, 171), -- Diubah ke Very Peri
	...
	["Title Text Color"] = Color3.fromRGB(102, 103, 171), -- Diubah ke Very Peri
	...
	["Background Image"] = "",
	["Page Selected Color"] = Color3.fromRGB(102, 103, 171), -- Diubah ke Very Peri
	["Section Text Color"] = Color3.fromRGB(220, 220, 210),
	["Section Underline Color"] = Color3.fromRGB(102, 103, 171), -- Diubah ke Very Peri
	["Toggle Border Color"] = Color3.fromRGB(102, 103, 171), -- Diubah ke Very Peri
	["Toggle Checked Color"] = Color3.fromRGB(230, 230, 230),
	["Toggle Desc Color"] = Color3.fromRGB(185, 185, 185),
	["Button Color"] = Color3.fromRGB(102, 103, 171), -- Diubah ke Very Peri
	["Label Color"] = Color3.fromRGB(38, 38, 42),
	["Dropdown Icon Color"] = Color3.fromRGB(230, 230, 230),
	["Dropdown Selected Color"] = Color3.fromRGB(102, 103, 171), -- Diubah ke Very Peri
	["Dropdown Selected Check Color"] = Color3.fromRGB(92, 93, 161), -- Diubah ke Very Peri (sedikit lebih gelap)
	["Textbox Highlight Color"] = Color3.fromRGB(102, 103, 171), -- Diubah ke Very Peri
	["Box Highlight Color"] = Color3.fromRGB(102, 103, 171), -- Diubah ke Very Peri
	["Slider Line Color"] = Color3.fromRGB(102, 103, 171), -- Diubah ke Very Peri
	["Slider Highlight Color"] = Color3.fromRGB(92, 93, 161), -- Diubah ke Very Peri (sedikit lebih gelap)
...
local libCreateNoti = function(Setting)
    ...
    TextLabelNoti.Text = "<font color=\"rgb(" .. tostring(color or "102,103,171") .. ")\">" .. tostring("Night Slayer Hub") .. "</font> " .. tostring(getgenv().TitleNameNoti or "") -- Diubah ke Very Peri
...
function Library:CreateWindow(Setting)
	...
	local colorB = tostring(Library_Function.Getcolor(getgenv().UIColor['Title Text Color'])[3])
	local color = colorR .. ',' .. colorG .. ',' .. colorB
    TextLabelMain.Text = "<font color=\"rgb(" .. tostring(color or "102,103,171") .. ")\">" .. tostring(TitleNameMain or "Night Slayer Hub") .. "</font> " .. tostring(getgenv().MainDesc or "") -- Diubah ke Very Peri
    ...
    if not GlobalSearch then
        GlobalSearch = function(searchText)
            ...
            for _, control in pairs(getgenv().AllControls) do
                ...
                -- Tandai section dengan elemen yang cocok
            ...
            for section, elements in pairs(elementsInSection) do
                ...
                for _, elementInfo in ipairs(elements) do
                    ...
                    if elementInfo.elementFound then
                        -- Elemen cocok: tampilkan elemen
                        control.Element.Visible = true
                        
                        -- Jika section juga cocok atau memiliki elemen yang cocok: tampilkan section
                    ...
                    elseif elementInfo.sectionFound and not hasElementMatch then
                        -- Section cocok tetapi tidak ada elemen yang cocok: hanya tampilkan section
                        control.Section.Visible = true
                        control.Element.Visible = false
            ...
            -- Jika tidak ditemukan apa pun, tampilkan pesan
            if not next(foundTabs) then
                -- Dapat menambahkan pesan "Tidak ditemukan hasil" di sini jika diinginkan
            end
        end
    end
    
    -- Sambungkan event search (tetap sama)
	...
	function Main_Function:AddTab(PageName)
		...
		function pageFunction:AddSection(Section_Name, Toggleable, SectionGap, SectionColor)
			...
			function sectionFunction:AddToggle(idk,Setting)
				...
				check.BackgroundColor3 = Color3.fromRGB(102, 103, 171) -- Diubah ke Very Peri
        ...
        function sectionFunction:AddButton(Setting, Callback)
            ...
            TextColor_1.Parent = RowBG_1
             ...
             ClickArea_1.BackgroundColor3 = Color3.fromRGB(102, 103, 171) -- Diubah ke Very Peri
             ...
             UIGradient_1.Color = ColorSequence.new{
                 ColorSequenceKeypoint.new(0, Color3.fromRGB(112, 113, 181)), -- Lebih terang Very Peri
                 ColorSequenceKeypoint.new(0.4, Color3.fromRGB(102, 103, 171)), -- Very Peri
                 ColorSequenceKeypoint.new(0.6, Color3.fromRGB(92, 93, 161)), -- Lebih gelap Very Peri
                 ColorSequenceKeypoint.new(1, Color3.fromRGB(82, 83, 151))  -- Paling gelap Very Peri
             }
             ...
             Button_1.MouseLeave:Connect(function()
                ...
                Button_1.MouseButton1Down:Connect(function()
                    ...
                    -- Dapatkan ukuran sebenarnya dari ClickArea
                    local w = ClickArea_1.AbsoluteSize.X
                    local h = ClickArea_1.AbsoluteSize.Y
                    
                    -- Buat ripple dengan bentuk sudut membulat seperti tombol (persegi panjang membulat)
                    ...
                    -- Buat UICorner untuk ripple dengan sudut membulat yang sama persis dengan tombol
                    local rippleCorner = Instance.new("UICorner")
                    rippleCorner.CornerRadius = UICorner_3.CornerRadius -- Ambil sudut membulat dari tombol
                    rippleCorner.Parent = ripple
                    
                    -- Animasi ripple meluas dari tengah ke seluruh tombol
            ...
            function sectionFunction:AddDropdownSection(Setting)
                ...
                -- Create internal section to hold controls
                ...
                -- Create dropdown section functions (ONLY SLIDER)
                local dropdownSectionFunction = {}
                
                -- SLIDER CREATION FUNCTION (WIDER, CLOSER TO EDGES)
                function dropdownSectionFunction:AddSlider(Setting)
                    ...
                    SliderFrame.Size = UDim2.new(1, 0, 0, 50)  -- Occupy full width
                    ...
                    SliderBG.Size = UDim2.new(1, -5, 1, 0)  -- Occupy almost full width (minus 5 pixels)
                    ...
                    SliderTitle.Size = UDim2.new(0.65, -10, 0, 25)  -- Title occupies 65%
                    ...
                    SliderBar.Size = UDim2.new(0.9, 0, 0, 6)  -- Slider bar is 90% wide
                    ...
                    Sliderboxframe.Size = UDim2.new(0.25, 0, 0, 25)  -- Textbox occupies 25%
			...
			function sectionFunction:AddDropdown(idk, Setting)
				...
				local ListNew
                local OrderedList = {} -- Add variable to save order
                if Selected then
                    ListNew = {}
                    for _, value in ipairs(List) do
                        -- Check if value matches Default then set true
                        ListNew[value] = (value == Default)
                        table.insert(OrderedList, value) -- Save order
                    end
                else
                    ListNew = List
                end
				...
				local controlData = {
                    ...
                    TabName = Page_Name,
                    TabButton = PageName,
                    SetValue = dropdownFunction.SetValue,  -- ADD THIS LINE
                    GetValue = dropdownFunction.GetValue   -- ADD THIS LINE
                }
                table.insert(getgenv().AllControls, controlData)
...
function sectionFunction:AddKeyBind(Setting, Callback)
    ...
    local Mode = Setting.Mode or "Toggle" -- Hold atau Toggle
